...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball team with intra-school and regional games",
    ...
    "Science Club": {
        "description": "Conduct experiments, explore STEM topics, and compete in science fairs",
